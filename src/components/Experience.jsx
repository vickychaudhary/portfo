  ...
  const experiences = [
    {
      ...
      highlights: [
        ...
        "Shipped unified GraphQL gateway powering dashboards and partner integrations",
        "Delivered AI-driven transaction insights using OpenAI function calling and embeddings",
    ...
    },
    {
      ...
      highlights: [
        ...
        "Introduced GraphQL federation to unify Node.js microservices",
        ...
        "Prototyped AI copilots for retailers using AWS Bedrock and function-chained Node.js services",
